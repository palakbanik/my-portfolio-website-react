                    ...
                    <div className="flex flex-col items-start">
                        ...
                        <div className="text-sm lg:text-base text-textLight flex flex-col gap-4 sm:gap-6 max-w-[600px]">
                            <p>
                                ...
                                specializes in front-end development. I am very
                                enthusiastic about bringing the technical and
                                visual aspects of digital products to life. User
                                experience, pixel perfect design, and writing
                                clear, readable, highly performant code matters
                                to me.
                            </p>
                            <p>
                                I began my journey as a web developer in 2024,
                                ...
                                way. I'm building cutting-edge web applications
                                using modern technologies such as Next.js,
                                TypeScript, Tailwindcss and much more.
                            </p>
                            <p>
